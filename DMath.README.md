# DMATH - MATHEMATICAL LIBRARY FOR DELPHI, FPC AND LAZARUS

Version 0.90 (December 2012)
...
This library is distributed under the terms of the GNU Lesser General Public License (LGPL). See file LGPL.TXT for details.
...
DMath provides routines and demo programs for numerical analysis, including mathematical functions, probabilities, matrices, optimization, linear and nonlinear equations, integration, Fast Fourier Transform, random numbers, curve fitting, statistics and graphics.
